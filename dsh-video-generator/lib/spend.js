...
export function confirmSpend(estCny, thresholdCny, confirmer) {
    if (estCny === null)
        return confirmer('unknown');
    if (estCny <= thresholdCny)
        return true;
