 ...
 */
export declare function slotRegistry(ctx: Context): SlotRegistryFace | undefined;
/**
 ...
 */
export declare function mountRemoteContribution(ctx: Context, contribution: TypertRemoteContribution): Promise<TypertDisposer>;
//# sourceMappingURL=dsh-contracts.d.ts.map