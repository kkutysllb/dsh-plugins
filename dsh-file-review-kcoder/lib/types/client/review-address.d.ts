 ...
 */
export declare function wrapChangesReviewOpen(right: SidebarRightStub, open: (coordinates: ChangesReviewCoordinates) => void): () => void;
//# sourceMappingURL=review-address.d.ts.map