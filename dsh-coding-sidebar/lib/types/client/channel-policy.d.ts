...
export declare const PLUGIN_DISPLAY_NAME = "dsh-coding-sidebar";
/** The `settings.section` list id this plugin registers under. */
export declare const SETTINGS_SECTION_ID = "dsh-coding-sidebar";
/**
 ...
 */
export declare const REPLACE_STOCK_SIDEBAR_SETTINGS = false;
